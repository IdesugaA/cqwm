package com.own.controller.notify;
...
public class PayNotifyController {
    ...
    private String decryptData(String body) throws Exception{
        ...
        String associateData = resource.getString("associated_data");

        AesUtil aesUtil = new AesUtil(weChatProperties.getApiV3Key().getBytes(StandardCharsets.UTF_8));

        //密文解密
        String plainText = aesUtil.decryptToString(associateData.getBytes(StandardCharsets.UTF_8),
    ...
    public void test(Long orderId , String number){
        //发送来单提醒到商家端前端
